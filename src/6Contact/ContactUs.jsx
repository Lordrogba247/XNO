...
function TikTokIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 256 290">
    ...
    return (
        <footer className="contact">
            ...
            <div className="contact__grid">
                ...
                <div className="contact__block">
                    <h3 className="contact__label">Follow us:</h3>
                    <div className="contact__socials">
                        <a
                            href="https://instagram.com/xnonights"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="contact__social-icon contact__social-icon--instagram"
                        ...
                        <a
                            href="https://instagram.com/xno_toronto"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="contact__social-icon contact__social-icon--instagram"
                            aria-label="Instagram"
