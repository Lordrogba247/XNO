...
function Bookings2() {
        ...
        try {
            const response = await fetch('https://api.web3forms.com/submit', {
                ...
                body: JSON.stringify({
                    ...
                    subject: 'New Booking Request - XNO',
    ...
    return (
        <section className="bookings2">
            <div className="bookings2__container">
                <h1 className="bookings2__title">Bookings</h1>
                <p className="bookings2__subtitle">
                    If you want bottle service kindly include in the description of
                    your reservation
                </p>

                <form className="bookings2__form" onSubmit={handleSubmit}>
